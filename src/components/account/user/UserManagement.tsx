            ...
            <div className="bg-white p-4 rounded-md shadow">
                ...
                <div>
                    <div className="flex justify-end mb-4">
                        <Link to="/manager/create-user" className="bg-gradient-to-r from-green-400 to-blue-500 text-white px-4 py-2 rounded-md hover:bg-gradient-to-l transition duration-300 shadow-lg">
                            Thêm tài khoản
                        </Link>
                    </div>
