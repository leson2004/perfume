...
const CreateDiscount: React.FC = () => {
    ...
    return (
        <Box sx={{ padding: 4, bgcolor: "#f9f9f9", borderRadius: 2, boxShadow: 3 }}>
            <Grid container spacing={4}>
                ...
                <Grid item xs={12} md={8}>
                    ...
                    <TableContainer sx={{ bgcolor: "white", borderRadius: 1, boxShadow: 1 }}>
                        <Table>
                            <TableHead>
                                <TableRow>
                            ...
                            <TableBody>
                                {products.map((product, index) => (
                                    <TableRow key={product.id}>
                                        ...
                                        <TableCell align="center">{(index + 1) + currentPage * 4}</TableCell>
